...
<div class="grid grid-cols-7 shadow p-2 rounded-xl hover:bg-slate-50">
  <div class="gap-x-4 col-span-4 flex items-center justify-start">
    <img src="{{ asset('images/chart/card_andini.png')}}" width="140" height="130" />
  ...
  <div class="flex items-center justify-center">
    <input type="number" id="{{'number_of_ticket_'.$loop}}" name="{{'number_of_ticket_'. $loop}}" min="0" max="10"
      class=" border-2 border-black rounded-xl w-12 h-12 text-center" value="0" />
  </div>
  ...
  <div class=" flex items-center justify-center">
    <a href="{{url('/remove_chart/'. $data->pre_order_id)}}">
