        ...
        <form action="{{route('register.store')}}" method="POST" class="flex flex-col items-center justify-center">
          ...
          <div class="w-3/4">
            ...
            <div class="mt-5 flex flex-col space-y-4">
              <x-input id="first_name" label="First Name" type="text" name="first_name" :value="old('first_name')"
                required autofocus placeholder="First Name" class="block mt-1 w-full" />
              <x-input id="last_name" label="Last Name" type="text" name="last_name" :value="old('last_name')" required
                autofocus placeholder="Last Name" class="block mt-1 w-full " />
              ...
              <x-input id="email" label="Email" type="text" name="email" :value="old('email')" required autofocus
                placeholder="Email" class="block mt-1 w-full" />
