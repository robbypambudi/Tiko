        ...
        <form action="{{route('login')}}" method="POST" class="flex flex-col items-center justify-center">
          ...
          <div class="w-3/4">
            ...
            <div class="mt-5 flex flex-col space-y-4">
              <x-input id="email" label="Email" type="email" name="email" :value="old('email')" required autofocus
            ...
            <div class="flex items-center justify-center mt-5">
              <a href="{{route('register')}}" class="text-center text-blue-500">Belum punya akun? Daftar</a>
            </div>
          </div>
        </form>
